<footer class="rcmp_footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-4">
        <ul class="list-unstyled">
          <li><a href="mailto:nekrasov@mlsco.ru?subject=rcmp_feedback">Нашли ошибку? Напишите сюда.</a></li>
          <li><small>Разработано <a href="//mlsco.ru">"Основные локальные сервисы."</a></small></li>
        </ul>
      </div>
    </div>
  </div>
